...
// Content Search Function for new pages
function performContentSearch(query) {
    ...
    displayContentSearchResults(searchItems);
}
...
// Display Search Results for content pages
function displayContentSearchResults(results) {
    const searchResults = document.getElementById('searchResults');
    if (!searchResults) return;
